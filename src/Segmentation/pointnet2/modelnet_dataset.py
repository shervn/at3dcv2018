...
class ModelNetDataset():
    ...
    def next_batch(self, augment=False):
        ...
        # batch_label = np.zeros((bsize), dtype=np.int32) # seems to be for classification
        batch_label = np.zeros((bsize, self.npoints), dtype=np.int32) # for sem segm
...
if __name__ == '__main__':
    print('HEY MODELNETTT') # doesn't get executed upon the file being imported elsewhere
