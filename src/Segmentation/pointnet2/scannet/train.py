...
LOG_OUT_NAME = 'log_train_scan_trial0.txt'
...
##########################
MODEL_OUT_NAME = "model_scan_trial0.ckpt"
...
RUN_DESCRIPTION = MODEL_OUT_NAME + "\n running scannet/train.py with the scannet data for trial"
...
def train():
    with tf.Graph().as_default():
        with tf.device('/gpu:' + str(GPU_INDEX)):
            pointclouds_pl, labels_pl, smpws_pl = MODEL.placeholder_inputs(BATCH_SIZE, NUM_POINT, 3)
